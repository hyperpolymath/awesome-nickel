...
help-me:
    @echo "=== awesome-nickel Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/awesome-nickel/issues/new"
    @echo ""
