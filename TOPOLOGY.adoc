...
A curated awesome list for Nickel, the universal configuration language.
Aggregates Nickel tools, editor support, integrations, libraries,
configuration examples, talks, and community resources. Nickel combines
JSON simplicity with functions, types, and contracts for static config
generation.
